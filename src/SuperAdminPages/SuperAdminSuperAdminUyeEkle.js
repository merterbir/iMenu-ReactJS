...
const SuperAdminSuperAdminUyeEkle = () => {
    const [UserName, setUserName, Password, setPassword, Token, setToken, dataToken, passwordErrorVis, setpasswordErrorVis, cookies, FirmaAdi, setFirmaAdi, FirmaMSayisi, setFirmaMSayisi, firmaAc, firmalariGetir, FirmaList, setFirmaList,silinecekIdFirma,setsilinecekIdFirma,firmaSil,firmaAyrinti,FirmaAyrinti, setFirmaAyrinti,
        FirmaAktifMi,setFirmaAktifMi,FirmaSilinmisMi,setFirmaSilinmisMi,firmaDuzenle,AdminUyeEkle,SuperAdminUyeEkle] = useContext(ApiContext);
    ...
    const AdminUyeEkleOnClick=(e)=>{
        e.preventDefault();
        SuperAdminUyeEkle(mail,sifre,isim,soyisim,telefon,sifreSoru,sifreSoruCevap,ikinciMail,dogumTarihi);
    }
        ...
        <div id="content" className="p-4 p-md-5 pt-5">
            <form className="modal-content animate"  method="post">
                <div className="container">
                    ...
                    <button onClick={AdminUyeEkleOnClick} type="submit">Super Admin Üye Ekle</button>
                </div>
            </form>
        </div>
    )
}
export default SuperAdminSuperAdminUyeEkle;