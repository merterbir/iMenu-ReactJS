            ...
            <form className="modal-content animate" method="post">
                <div className="container">
                    <table className="table">
                        ...
                        <tbody>
                            {/* {FirmaList.map(Firma => ( 
                                (Firma.isDeleted?<tr key={Firma.id}>
                                    <td>{Firma.name}</td>
                            ...
                            {FirmaList.map(((   item,i)=>
                            (item.isDeleted?<tr key={i}>
                                <td>{item.name}</td>
                                <td>{item.deskCount}</td>
                                <td><button style={{ backgroundColor: 'grey' }} onClick={ayrintiGetir} value={item.id}>Ayrıntılar <i className="bi bi-body-text"></i></button></td>
                                <td><button onClick={duzenleClick} value={item.id}>Düzenle <i className="bi bi-pencil-square"></i></button></td>
                                <td><button style={{ backgroundColor: 'red' }} onClick={silButton} value={item.id}>Sil <i className="bi bi-trash-fill"></i></button></td>
                            </tr>:null)
